    ...
    window.$parsleyLoaded(function (window, document, parsley) {
      ...
      function startProspectPolling(prospectId, buttonLabelTimer) {
        ...
        function poll() {
          $.ajax({
            type: 'GET',
            // TODO: Update before go live
            url: `https://farsight-production.herokuapp.com/api/v1/company/prospects/${prospectId}`,
            ...
            statusCode: {
              ...
              200: function (data) {
                ...
                trackSubmission();
                window.location.href = `/employers/test-employers-get-started?prospect_id=${prospectId}`;
              },
              401: function (data) {
      ...
      function onSubmitForm(token, e) {
        ...
        if (form.parsley().validate()) {
          ...
          $.ajax({
            type: 'POST',
            // TODO: Update before go live
            url: 'https://farsight-production.herokuapp.com/api/v1/company/prospects',
            data: JSON.stringify({
